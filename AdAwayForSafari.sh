...
rm -r whosts
echo 'Adding https://localhost/AdAwayForSafari.lsrules as New Rule Group Subscription in Little Snitch'
open "x-littlesnitch:subscribe-rules?url=https://localhost/AdAwayForSafari.lsrules"
